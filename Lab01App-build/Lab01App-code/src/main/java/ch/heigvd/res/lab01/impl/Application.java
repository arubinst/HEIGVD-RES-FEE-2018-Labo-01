...
public class Application implements IApplication {
  ...
  void storeQuote(Quote quote, String filename) throws IOException {
    String folderTree = WORKSPACE_DIRECTORY;
    for (String folderName: quote.getTags()) {
      folderTree += "/" + folderName;
    }
    Files.createDirectories(Paths.get(folderTree));
    folderTree += "/" + filename;
    OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream(folderTree), StandardCharsets.UTF_8);
  ...
  public String getAuthorEmail() {
    return "michael.brouchoud@heig-vd.ch";
  }
